...
pub const BUILDER_WITHDRAWAL_PREFIX = 3;
...
pub const DOMAIN_BEACON_BUILDER = [_]u8{ 11, 0, 0, 0 };
pub const DOMAIN_PTC_ATTESTER = [_]u8{ 12, 0, 0, 0 };
pub const DOMAIN_PROPOSER_PREFERENCES = [_]u8{ 13, 0, 0, 0 };
...
pub const MIN_BUILDER_WITHDRAWABILITY_DELAY: u64 = 64;
