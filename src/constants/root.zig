...
pub const BUILDER_WITHDRAWAL_PREFIX = 3; // Gloas (EIP-7732)
...
// Gloas (EIP-7732) domains
pub const DOMAIN_BEACON_BUILDER = [_]u8{ 11, 0, 0, 0 }; // 0x0B000000
pub const DOMAIN_PTC_ATTESTER = [_]u8{ 12, 0, 0, 0 }; // 0x0C000000
pub const DOMAIN_PROPOSER_PREFERENCES = [_]u8{ 13, 0, 0, 0 }; // 0x0D000000
pub const DOMAIN_BUILDER_DEPOSIT = [_]u8{ 14, 0, 0, 0 }; // 0x0E000000
...
pub const BUILDER_INDEX_FLAG: u64 = 1 << 40; // 2**40
pub const BUILDER_INDEX_SELF_BUILD: u64 = std.math.maxInt(u64);
pub const BUILDER_PAYMENT_THRESHOLD_NUMERATOR = 6;
pub const BUILDER_PAYMENT_THRESHOLD_DENOMINATOR = 10;
pub const PAYLOAD_BUILDER_VERSION = 0;
...
pub const BUILDER_DEPOSIT_REQUEST_TYPE = 0x03;
pub const BUILDER_EXIT_REQUEST_TYPE = 0x04;
