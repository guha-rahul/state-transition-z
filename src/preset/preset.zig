...
const PresetMainnet = struct {
    ...
    pub const BUILDER_REGISTRY_LIMIT = 1_099_511_627_776; // 2^40
    pub const BUILDER_PENDING_WITHDRAWALS_LIMIT = 1_048_576; // 2^20
    pub const MAX_BUILDERS_PER_WITHDRAWALS_SWEEP = 16_384; // 2^14
};
